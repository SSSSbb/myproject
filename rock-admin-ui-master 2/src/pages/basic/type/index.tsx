...
import { queryType, addType, deleteType, updateType } from './service';
      ...
      <Access accessible={access.basicTypeIndex!}>
        <ProTable
          ...
          request={async (params = {}) => {
            ...
            console.log({ rsp });
            const response = await queryType({ ...params, belongto: rsp.data?.belongto });
        ...
        {createModalVisible && (
          <ModalForm
            ...
            onFinish={async (value) => {
              ...
              const response = await addType(value as TableListItem);
              const { code, msg } = response;
              if (code !== 200) {
                message.error(msg);
                return;
