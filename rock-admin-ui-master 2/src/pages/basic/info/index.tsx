...
import { queryInfo, addInfo, deleteInfo, updateInfo } from './service';
      ...
      <Access accessible={access.basicTypeIndex!}>
        <ProTable
          ...
          request={async (params = {}) => {
            ...
            const response = await queryInfo({ ...params, belongto: rsp.data?.belongto });
        ...
        {createModalVisible && (
          <ModalForm
            ...
            onFinish={async (value) => {
              ...
              const response = await addInfo(value as TableListItem);
              const { code, msg } = response;
              if (code !== 200) {
                message.error(msg);
                return;
